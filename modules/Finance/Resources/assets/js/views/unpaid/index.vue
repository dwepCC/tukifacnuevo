                ...
                <div class="h-auto">
                    ...
                    <div class="d-flex justify-content-between pb-0">
                        <div class="btn-filter-content">
                            <el-button type="secondary" class="btn-show-filter" :class="{ shift: isVisible }"
                        ...
                        <el-dropdown :hide-on-click="false">
                            ...
                            <el-dropdown-menu slot="dropdown">
                                <el-dropdown-item v-for="(column, index) in columns" :key="index">
                                    <el-checkbox v-model="column.visible" @change="saveColumnVisibility">{{ column.title
                                        }}</el-checkbox>
                                </el-dropdown-item>
                            </el-dropdown-menu>
                        </el-dropdown>
                                    ...
                                    <div>
                                        <div class="row" v-if="isVisible">
                                            ...
                                            <div class="col-md-3 form-modern">
                                                ...
                                                <el-select v-model="form.date_type" @change="loadUnpaid">
                                                    <el-option key="emission" value="emission"
                                                        label="Fecha de emisión"></el-option>
                                                    <el-option key="due" value="due"
                                            ...
                                            ">
                                                <div class="col-md-3">
                                                    ...
                                                    <el-date-picker v-model="form.month_start" type="month" @change="
                                            ...
                                            ">
                                                <div class="col-md-3">
                                                    ...
                                                    <el-date-picker v-model="form.month_end" type="month"
                                                        @change="loadUnpaid" :picker-options="pickerOptionsMonths
                                                            " value-format="yyyy-MM" format="MM/yyyy"
                                                        :clearable="false"></el-date-picker>
                                                </div>
                                            </template>
                                            ...
                                            ">
                                                <div class="col-md-3 form-modern">
                                                    ...
                                                    <el-date-picker v-model="form.date_start" type="date" @change="
                                                        changeDisabledDates
                                            ...
                                            ">
                                                <div class="col-md-3 form-modern">
                                                    ...
                                                    <el-date-picker v-model="form.date_end" type="date" :picker-options="pickerOptionsDates
                                                        " @change="loadUnpaid" value-format="yyyy-MM-dd"
                                            ...
                                            <div class="col-md-3 form-modern" v-if="columns.estado.visible">
                                                ...
                                                <el-select v-model="form.estado" clearable
                                                    placeholder="Seleccionar estado" @change="loadUnpaid">
                                            ...
                                            <div v-if="typeUser == 'admin'" class="col-md-4 form-modern">
                                                ...
                                                <el-select @change="changeUser" filterable clearable
                                                    v-model="form.user_id" placeholder="Seleccionar usuario">
                                            ...
                                            <div class="col-lg-3 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <el-select v-model="form.web_platform_id
                                                        " clearable @change="changeWebPlatform">
                                            ...
                                            <div class="col-md-2 form-modern">
                                                ...
                                                " filterable clearable v-model="form.payment_method_type_id
                                                                ...
                                                                " :key="index">
                                                                    ...
                                                                    ">
                                                                        <template v-if="row.web_platforms !== undefined">
                                                                            <template v-for="(platform, index) in row.web_platforms" :key="index">
                                                                                <label class="d-block">{{
                                                                                    platform.name
                                                                                    }}</label>
                                                                            </template>
