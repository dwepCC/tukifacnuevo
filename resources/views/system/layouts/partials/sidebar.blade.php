...
@endphp
<aside id="sidebar-left" class="mt-0 w-64 bg-white text-gray-900 min-h-screen border-r border-gray-200" style="z-index: 900">
    <div class="px-2 overflow-y-auto h-full">
        <div class="px-1">
            <nav id="menu" class="pt-1 space-y-1" role="navigation">
                <ul class="space-y-1">
                    <li class="{{ (in_array($path[0], ['clients', 'dashboard']))?'nav-active':'' }}">
                        <a class="flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-100 text-gray-700" href="{{route('system.dashboard')}}">
            ...
            <nav id="menu" class="space-y-1" role="navigation">
                <ul class="space-y-1">
                    <li class="{{ ($path[0] === 'payment-orders')?'nav-active':'' }}">
                        <a class="flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-100 text-gray-700" href="{{route('system.payments.index')}}">
                ...
                <nav id="menu" class="space-y-1" role="navigation">
                    <ul class="space-y-1">
                        <li class="{{ ($path[0] === 'multi-users')?'nav-active':'' }}">
                            <a class="flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-100 text-gray-700" href="{{route('system.multi-users.index')}}">
            ...
            <nav id="menu" class="space-y-1" role="navigation">
                <ul class="space-y-1">
                    <li class="{{ ($path[0] === 'plans')?'nav-active':'' }}">
                        <a class="flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-100 text-gray-700" href="{{route('system.plans.index')}}">
            ...
            <nav id="menu" class="space-y-1" role="navigation">
                <ul class="space-y-1">
                    <li class="{{ ($path[0] === 'massive-invoice')?'nav-active':'' }}">
                        <a class="flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-100 text-gray-700" href="{{route('system.massive-invoice.index')}}">
            ...
            <nav id="menu" class="space-y-1" role="navigation">
                <ul class="space-y-1">
                    <li class="{{ ($path[0] === 'accounting')?'nav-active':'' }}">
                        <a class="flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-100 text-gray-700" href="{{route('system.accounting.index')}}">
            ...
            <nav id="menu" class="space-y-1" role="navigation">
                <ul class="space-y-1">
                    <li class="{{ ($path[0] === 'auto-update')?'nav-active':'' }}">
                        <a class="flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-100 text-gray-700" href="{{route('system.update')}}">
            ...
            <nav id="menu" class="space-y-1" role="navigation">
                <ul class="space-y-1">
                    <li class="{{ ($path[0] === 'backup')?'nav-active':'' }}">
                        <a class="flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-100 text-gray-700" href="{{route('system.backup')}}">
            ...
            <nav id="menu" class="space-y-1" role="navigation">
                <ul class="space-y-1">
                    <li class="{{ ($path[0] === 'information')?'nav-active':'' }}">
                        <a class="flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-100 text-gray-700" href="{{route('system.information')}}">
            ...
            <nav id="menu" class="space-y-1" role="navigation">
                <ul class="space-y-1">
                    <li class="">
                        <a class="flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-100 text-gray-700" href="{{url('logs')}}" target="_BLANK">
            ...
            <nav id="menu" class="pb-2 space-y-1" role="navigation">
                <ul class="space-y-1">
                    <li class="{{ ($path[0] === 'reports')?'nav-active':'' }}">
                        <a class="flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-100 text-gray-700" href="{{ route('system.list-reports') }}">
    ...
    <nav id="menu" class="configuration-nav pt-0 px-2 space-y-1" role="navigation">
        <ul class="space-y-1">
            <li class="{{ ($path[0] === 'configurations')?'nav-active':'' }}">
                <a class="flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-100 text-gray-700" href="{{route('system.configuration.index')}}">
